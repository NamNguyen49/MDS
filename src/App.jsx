                  ...
                  >
                    <div style={{ position: "relative", zIndex: 2 }}>
                      ...
                      >
                        ...
                        <b>{TOTAL_COMPONENTS}</b> core components are verified
                  ...
                  <div className="doc-section when-to-use-section">
                    ...
                    <div className="doc-content">
                      <p className="m3-body-medium">
                        Mỗi màu sắc trong hệ thống đều mang một ý nghĩa ngữ
                        nghĩa (semantic) cụ thể:
                      </p>
              ...
              {activeTab === "typography" && (
                <div className="component-doc-page">
                  <div className="doc-section hero-section">
                    ...
                    <p className="m3-body-large doc-intro">
                      Hệ thống phông chữ MDR sử dụng Outfit cho tiêu đề và
                      Roboto cho nội dung, tuân thủ nghiêm ngặt các tỷ lệ của
                      Material Design 3.
                    </p>
                  </div>
                  ...
                  <div className="doc-section when-to-use-section">
                    ...
                    <div className="doc-content">
                      ...
                      <ul className="m3-body-medium">
                        <li>
                          🖥️ <b>Display:</b> Dùng cho các con số hoặc tiêu đề
                          cực lớn trên màn hình rộng.
                        </li>
                        <li>
                          📰 <b>Headline:</b> Dùng cho các tiêu đề trang hoặc
                          tiêu đề phần quan trọng.
                        </li>
                        <li>
                          🏷️ <b>Title:</b> Dùng cho các tiêu đề trong card,
                          dialog hoặc các đề mục nhỏ.
                        </li>
                        <li>
                          📝 <b>Body:</b> Dùng cho nội dung văn bản chính, đảm
                          bảo khả năng đọc tốt nhất.
                        </li>
                        <li>
                      ...
                      <ExampleCard
                        ...
                        component={
                          ...
                          >
                            ...
                            <p className="m3-body-medium">
                              Đây là nội dung văn bản mẫu sử dụng Body Medium.
                              Nó được tối ưu hóa để người dùng có thể đọc một
                              cách hoàn toàn thoải mái.
                            </p>
                          </div>
                        }
                ...
                <div className="component-doc-page">
                  ...
                  <div className="doc-section when-to-use-section">
                    ...
                    <div className="doc-content">
                      ...
                      <ul className="m3-body-medium">
                        <li>
                          ✨ <b>Nhất quán:</b> Luôn sử dụng biến thể "Rounded"
                          để phù hợp với ngôn ngữ thiết kế M3.
                        </li>
                        <li>
                    ...
                    >
                      ...
                      >
                        ...
                        <p
                          ...
                          style={{ marginTop: "12px", opacity: 0.8 }}
                        >
                          Mã nguồn <code>@font-face</code> đã được định nghĩa
                          sẵn trong <code>index.css</code>. Bạn có thể dễ dàng
                          di chuyển sang bất kỳ dự án nào.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              {activeTab === "buttons" && (
                <div className="component-doc-page">
                  ...
                  <div className="doc-section hero-section">
                    ...
                    <p className="m3-body-large doc-intro">
                      Nút bấm giúp người dùng thực hiện các hành động chỉ với
                      một lần chạm. Material 3 cung cấp nhiều kiểu dáng để phân
                      cấp mức độ ưu tiên của hành động.
                    </p>
                  </div>
                  ...
                  <div className="doc-section when-to-use-section">
                    ...
                    <div className="doc-content">
                      ...
                      <ul className="m3-body-medium">
                        <li>
                          🔵 <b>Primary button:</b> Dùng cho hành động quan
                          trọng nhất (call to action). Chỉ nên có 1 nút chính
                          trong 1 khu vực.
                        </li>
                        <li>
                        ...
                        <li>
                          ☁️ <b>Elevated button:</b> Dùng khi cần làm nổi bật
                          trên nền giao diện phức tạp.
                        </li>
                        <li>
                ...
                <div className="component-doc-page">
                  ...
                  <div className="doc-section hero-section">
                    ...
                    <p className="m3-body-large doc-intro">
                      ...
                      bản. Chúng thường xuất hiện trong các biểu mẫu và hộp
                      thoại.
                    </p>
                  </div>
                  ...
                  <div className="doc-section when-to-use-section">
                    ...
                    <div className="doc-content">
                      <p className="m3-body-medium">
                        ...
                        thông tin văn bản tự do. Sử dụng <b>SearchBar</b> cho
                        các chức năng tìm kiếm dữ liệu. Sử dụng <b>Select</b>{" "}
                        khi người dùng cần chọn một hoặc nhiều tùy chọn từ danh
                        sách có sẵn (thay vì nhập liệu tự do).
                      </p>
                    </div>
                  </div>
                ...
                <div className="component-doc-page">
                  ...
                  <div className="doc-section when-to-use-section">
                    ...
                    <div className="doc-content">
                      ...
                      <ul className="m3-body-medium">
                        <li>
                          🔘 <b>Radio Group:</b> Dùng khi người dùng chỉ được
                          chọn DUY NHẤT một tùy chọn trong một danh sách.
                        </li>
                        <li>
                          ☑️ <b>Checkbox:</b> Dùng khi người dùng có thể chọn
                          một hoặc nhiều tùy chọn, hoặc xác nhận một điều khoản.
                        </li>
                        <li>
                          🔛 <b>Switch:</b> Dùng để bật hoặc tắt một trạng thái
                          hệ thống ngay lập tức (ví dụ: Dark mode, Wifi).
                        </li>
                        <li>
...
/>`}
              ...
              {activeTab === "navigation" && (
                <div className="component-doc-page">
                  ...
                  <div className="doc-section when-to-use-section">
                    ...
                    <div className="doc-content">
                      <p className="m3-body-medium">
                        Việc lựa chọn kiểu điều hướng phụ thuộc vào cấu trúc
                        thông tin và kích thước màn hình:
                      </p>
                      <ul className="m3-body-medium">
                        <li>
                        ...
                        <li>
                          📱 <b>Bottom Navigation:</b> Dùng cho các điểm đến
                          chính trên thiết bị di động (3-5 mục).
                        </li>
                        <li>
              ...
              {activeTab === "chips" && (
                <div className="component-doc-page">
                  <div className="doc-section hero-section">
                    ...
                    <p className="m3-body-large doc-intro">
                      Các thành phần nhỏ dùng để hiển thị trạng thái, thuộc
                      tính, hoặc định danh người dùng một cách súc tích.
                    </p>
                  </div>
                  ...
                  <div className="doc-section when-to-use-section">
                    ...
                    <div className="doc-content">
                      ...
                      <ul className="m3-body-medium">
                        <li>
                          🏷️ <b>Chips:</b> Dùng cho các thẻ nhập liệu, bộ lọc
                          hoặc các lựa chọn nhanh.
                        </li>
                        <li>
                        ...
                        <li>
                          👤 <b>Avatars:</b> Dùng để đại diện cho người dùng
                          thông qua hình ảnh hoặc tên viết tắt.
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              {activeTab === "cards" && (
                <div className="component-doc-page">
                  <div className="doc-section hero-section">
                    ...
                    <p className="m3-body-large doc-intro">
                      Các thành phần dùng để chứa và tổ chức nội dung một cách
                      có cấu trúc, giúp giao diện trở nên gọn gàng và dễ quét
                      thông tin.
                    </p>
                  </div>
                  ...
                  <div className="doc-section when-to-use-section">
                    ...
                    <div className="doc-content">
                      ...
                      <ul className="m3-body-medium">
                        <li>
                          🗂️ <b>Cards:</b> Một entry point cho thông tin chi
                          tiết (ảnh, text, actions). Dùng cho dashboards hoặc
                          news feeds.
                        </li>
                        <li>
                          📜 <b>Lists:</b> Hiển thị nhiều mục thông tin liên
                          tục. Dùng cho cài đặt, danh bạ hoặc menu.
                        </li>
                        <li>
                ...
                <div className="component-doc-page">
                  <div className="doc-section hero-section">
                    ...
                    <p className="m3-body-large doc-intro">
                      ...
                      cách có tổ chức, cho phép người dùng so sánh và phân tích
                      dữ liệu hiệu quả.
                    </p>
                  </div>
                  ...
                  <div className="doc-section when-to-use-section">
                    ...
                    <div className="doc-content">
                      ...
                      <ul className="m3-body-medium">
                        <li>
                          📊 Cần hiển thị nhiều cột thông tin cho mỗi mục dữ
                          liệu.
                        </li>
                        <li>
                ...
                <div className="component-doc-page">
                  ...
                  <div className="doc-section when-to-use-section">
                    ...
                    <div className="doc-content">
                      ...
                      <ul className="m3-body-medium">
                        <li>
                          📉 <b>Linear Progress:</b> Dùng cho các tiến trình
                          chiếm không gian ngang (như tải file).
                        </li>
                        <li>
                          🔄 <b>Circular Progress:</b> Dùng cho các hành động
                          cần chờ đợi tại chỗ (như loading trang).
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              {activeTab === "dialogs" && (
                <div className="component-doc-page">
                  <div className="doc-section hero-section">
                    ...
                    <p className="m3-body-large doc-intro">
                      Các thành phần hiển thị trên lớp bề mặt hiện tại để thu
                      hút sự chú ý của người dùng hoặc cung cấp nội dung bổ
                      sung.
                    </p>
                  </div>
                    ...
                    <div className="doc-content">
                      ...
                      <ul className="m3-body-medium">
                        ...
                        <li>
                          ...
                          sung hoặc hành động phụ mà không làm mất ngữ cảnh
                          trang chính.
                        </li>
                        <li>
                ...
                <div className="component-doc-page">
                  ...
                  <div className="doc-section when-to-use-section">
                    ...
                    <div className="doc-content">
                      ...
                      <ul className="m3-body-medium">
                        <li>
                          🚀 <b>Toasts:</b> Các thông báo nổi (Global) tự biến
                          mất sau 3-5 giây. Dùng cho kết quả thành công/thất
                          bại.
                        </li>
                        <li>
              ...
              {activeTab === "pagination" && (
                <div className="component-doc-page">
                  <div className="doc-section hero-section">
                    ...
                    <p className="m3-body-large doc-intro">
                      Chia nhỏ danh sách dữ liệu dài thành các trang để cải
                      thiện hiệu suất và trải nghiệm người dùng.
                    </p>
                  </div>
                  ...
                  <div className="doc-section when-to-use-section">
                    ...
                    <div className="doc-content">
                      <p className="m3-body-medium">
                        Phân trang là cần thiết khi số lượng mục dữ liệu vượt
                        quá khả năng quét nhanh của người dùng:
                      </p>
                      <ul className="m3-body-medium">
                        <li>
        ...
        >
          ...
          >
            <p className="m3-body-medium">
              Side sheets are used to present supplementary content that
              supports the main content of a page.
            </p>
